 ...
 */
final class Version20210204141212 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE artiste (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) DEFAULT NULL, genre VARCHAR(255) DEFAULT NULL, thumbnail VARCHAR(255) DEFAULT NULL, day VARCHAR(255) DEFAULT NULL, time VARCHAR(255) DEFAULT NULL, time_value VARCHAR(255) DEFAULT NULL, place VARCHAR(255) DEFAULT NULL, type VARCHAR(255) DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
